...
public class Exit 
{
	...
	// Member variables
	private StationRooms m_leadsTo = null;
	...
	// Full constructor
	public Exit( int direction, StationRooms leadsTo )
	{
	...
	// Assigns StationRooms
	public void setLeadsTo ( StationRooms leadsTo )
	{
		m_leadsTo = leadsTo;
	}

	// Returns StationRooms
	public StationRooms getLeadsTo (  )
	{
		return m_leadsTo;
	}
